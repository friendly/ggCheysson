...
The Albums were produced by the Ministry of Public Works in France under the direction of [Émile Cheysson](https://en.wikipedia.org/wiki/%C3%89mile_Cheysson) from 1879-1897. They represent the "pinnacle of the Golden Age of Statistical Graphics"
...
```{r with-fonts, fig.height=5, fig.width=7, eval=FALSE}
...
```{r complete-aesthetic, fig.height=5, fig.width=7, eval=FALSE}
library(ggpattern)
